...
function perYear(data) {
    ...
    // data2018 = [{"9":220},{"10":141},{"11":89},{"12":16}]
    var data2017 = data[2017]  //extract the information associated with the key "2016" and put this info in a variable called data2018
    ...
    //So data2018[0][9] means look at the zero-ith array element {"9":220} and extract the data associated the key 9
    //result should be 220 
    console.log(data2017[0][1]) //print data to the console to make sure we did it right
